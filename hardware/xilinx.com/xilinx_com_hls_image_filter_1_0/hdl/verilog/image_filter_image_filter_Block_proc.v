...
module image_filter_image_filter_Block_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_sig_bdd_31;
wire   [11:0] img_0_rows_V_fu_29_p1;
wire   [11:0] img_0_cols_V_fu_33_p1;
...
begin : ap_ret_ap_return_0_preg
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
            ap_return_0_preg <= img_0_rows_V_fu_29_p1;
        end
    end
end
...
begin : ap_ret_ap_return_1_preg
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
            ap_return_1_preg <= img_0_cols_V_fu_33_p1;
        end
    end
end
...
begin : ap_ret_ap_return_2_preg
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
            ap_return_2_preg <= img_0_rows_V_fu_29_p1;
        end
    end
end
...
begin : ap_ret_ap_return_3_preg
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
            ap_return_3_preg <= img_0_cols_V_fu_33_p1;
        end
    end
end
...
always @ (ap_CS_fsm or ap_sig_bdd_31 or img_0_rows_V_fu_29_p1 or ap_return_0_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
        ap_return_0 = img_0_rows_V_fu_29_p1;
    end else begin
...
always @ (ap_CS_fsm or ap_sig_bdd_31 or img_0_cols_V_fu_33_p1 or ap_return_1_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
        ap_return_1 = img_0_cols_V_fu_33_p1;
    end else begin
...
always @ (ap_CS_fsm or ap_sig_bdd_31 or img_0_rows_V_fu_29_p1 or ap_return_2_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
        ap_return_2 = img_0_rows_V_fu_29_p1;
    end else begin
...
always @ (ap_CS_fsm or ap_sig_bdd_31 or img_0_cols_V_fu_33_p1 or ap_return_3_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
        ap_return_3 = img_0_cols_V_fu_33_p1;
    end else begin
...
assign img_0_cols_V_fu_33_p1 = cols[11:0];
assign img_0_rows_V_fu_29_p1 = rows[11:0];


endmodule //image_filter_image_filter_Block_proc
